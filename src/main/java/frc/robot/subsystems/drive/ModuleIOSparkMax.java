...
public class ModuleIOSparkMax implements ModuleIO {
  ...
  // find right device ids for SparkMax
  public ModuleIOSparkMax(int index) {
    switch (index) {
      ...
      case 3:
        ...
        turnAbsoluteEncoder = new CANcoder(15);
        absoluteEncoderOffset = new Rotation2d(0.0); // MUST BE CALIBRATED
        break;
      default:
    ...
    turnPositionQueue =
        SparkMaxOdometryThread.getInstance()
            .registerSignal(
                () -> {
                  double value = turnAbsoluteEncoder.getPosition().getValueAsDouble();
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnAbsolutePosition =
        Rotation2d.fromRotations(turnAbsoluteEncoder.getPosition().getValueAsDouble())
            .minus(absoluteEncoderOffset);
    inputs.turnPosition =
        Rotation2d.fromRotations(
            turnAbsoluteEncoder.getPosition().getValueAsDouble() / TURN_GEAR_RATIO);
    inputs.turnVelocityRadPerSec =
        Units.rotationsToRadians(turnAbsoluteEncoder.getVelocity().getValueAsDouble())
            / TURN_GEAR_RATIO;
